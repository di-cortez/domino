...
training.rl.cli):
  ...
  --rl-opponent-buckets NAMES  Comma-separated buckets: heuristic,random,recent,medium_term,historical_uniform,champion_vs_heuristic (default: $RL_OPPONENT_BUCKETS)
