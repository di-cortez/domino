...
training.rl.cli):
  ...
  --rl-opponent-buckets NAMES  Comma-separated buckets: heuristic,random,recent,medium_term,historical_uniform,champion_vs_heuristic,champion_vs_learner (default: $RL_OPPONENT_BUCKETS)
